...
export class PurchaseService {
  ...
  getAllBySupplierId(target: string, supplierCOALevel04Id?: number) {
    this.url = `${this.baseUrl}${target}/GetAllPurchaseOrders`;
    const params = [];
    if (supplierCOALevel04Id !== undefined) {
      params.push(`SupplierCOALevel04Id=${supplierCOALevel04Id}`);
    }
    if (params.length > 0) {
      this.url += `?${params.join("&")}`;
    }
  ...
  getAllPendingBySupplierId(target: string, supplierCOALevel04Id?: number) {
    this.url = `${this.baseUrl}${target}/GetPendingPayments`;
    const params = [];
    if (supplierCOALevel04Id !== undefined) {
      params.push(`SupplierCOALevel04Id=${supplierCOALevel04Id}`);
    }
  ...
  getAllBySupplier(target: string, supplierCOALevel04Id?: number) {
    this.url = `${this.baseUrl}${target}/GetAll`;
    const params = [];
    if (supplierCOALevel04Id !== undefined) {
      params.push(`SupplierCOALevel04Id=${supplierCOALevel04Id}`);
  ...
  // savePolicies(target: string, dto:any, userId: number, policyId: number) {
  //   const url = `${this.baseUrl}${target}/PolicyAllocation?userId=${userId}&policyId=${policyId}`;
  //   return this.http.post(this.url, dto);
  // }
  savePolicies(target: string, dto: any) {
    const url = `${this.baseUrl}${target}/PolicyAllocation?userId=${dto.userId}&policyId=${dto.policyType}`;
  ...
  create(dto: any, target: string) {
    console.log("Purchase Order Data Do", dto);
  ...
  getLastPurchaseRate(
    ...
    itemId: number,
    unitId: number,
    SupplierCOALevel04Id: number
  ) {
    this.url = this.baseUrl;
    this.url += `${target}/GetLatestRate?ItemId=${itemId}&SupplierCOALevel04Id=${SupplierCOALevel04Id}&UnitId=${unitId}`;
    return this.http.get(this.url).pipe(
      map((response: any) => {
        return response["result"];
      })
